...
import {Splash, Started, Register, Login, UploadPhoto, Doctor, Hospital, Message} from '../pages';
...
const Router = ()=> {
    return (
        <Stack.Navigator>
            ...
            <Stack.Screen name='UploadPhoto' component={UploadPhoto} options={{headerShown: false}}></Stack.Screen>
